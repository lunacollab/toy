...
const ManageStaff = () => {
    ...
    const displayedStaff = filteredStaff.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <main className="max-w-7xl mx-auto py-6 px-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-semibold text-gray-900">Manage Staff</h2>
                        <button 
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        <div className="mb-4 flex items-center">
                            ...
                            />
                            <button className="ml-3 bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition" onClick={handleSearch}>
                            ...
                            <tbody>
                                {displayedStaff.map((staff) => (
                                    <tr key={staff.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="py-3 px-4 text-gray-700">{staff.name}</td>
